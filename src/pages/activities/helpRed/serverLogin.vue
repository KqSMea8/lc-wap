<template>
  <app-layout id="helpRed_serverLogin">
    ...
    export default {
      ...
      methods: {
        next(){
          let wid=this.wid;
          if(wid!==''){
            this.$router.push('/helpRed/buildLink/'+this.$route.params.aid+'?wid='+wid+'&type='+this.$route.query.type);
          }else{
...
<style lang="scss">
    ...
    #helpRed_serverLogin{font-size:$h3;padding-bottom:.51rem;
