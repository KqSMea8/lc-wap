<template>
  <app-layout id="helpRed_buildLink">
    ...
    methods: {
      async getData () {
        ...
        if (res.errcode == 0) {
          ...
          this.link = '/helpRed/poster/' + this.$route.params.aid + '?sid=' + this.data.consultantId+'&type='+this.$route.query.type;
...
<style lang="scss">
    ...
    #helpRed_buildLink{font-size:$h3;padding-bottom:.51rem;
